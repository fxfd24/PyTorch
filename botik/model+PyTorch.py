...
def train_model():
    ...
    last_data = scaler.transform(last_data.reshape(1, look_back, 4))
    ...
    print(f'Predicted OPEN: {predicted_price[0, 0]}\nPredicted HIGH: {predicted_price[0, 1]}\nPredicted LOW: {predicted_price[0, 2]}\nPredicted CLOSE: {predicted_price[0, 3]}')
